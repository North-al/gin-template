...
type IUserDo interface {
	...
	FindById(ctx context.Context, id int64) (result *entity.UserEntity, err error)
	FindByPhone(ctx context.Context, phone string) (result *entity.UserEntity, err error)
}

// SELECT * FROM @@table WHERE id = @id LIMIT 1
func (u userDo) FindById(ctx context.Context, id int64) (result *entity.UserEntity, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM t_users WHERE id = ? LIMIT 1 ")
...
func (u userDo) FindByPhone(ctx context.Context, phone string) (result *entity.UserEntity, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, phone)
	generateSQL.WriteString("SELECT * FROM t_users WHERE phone = ? LIMIT 1 ")
